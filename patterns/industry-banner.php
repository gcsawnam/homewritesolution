...
<p class="has-text-color has-link-color" style="color:#ced4da;font-size:21px;font-style:normal;font-weight:400;line-height:1.7">Good advice can be hard to find. Fortunately, we’ve compiled an enormous collection of resources on marketing written by experts with years of experience. Whether you’re a heavy equipment manufacturer curious about email marketing or a fashion retailer trying SEO for the first time – or somewhere in between – we have advice, tips, and ideas just for you. Browse the collection below, or give us a shout using the contact form on any page to let us know what you’d like to see us write about next.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"14%"} -->
<div class="wp-block-column" style="flex-basis:14%"></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->