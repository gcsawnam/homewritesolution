...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() );?>/assets/img/sucess-6.jpg","id":224,"dimRatio":50,"minHeight":215,"contentPosition":"center center","isDark":false,"style":{"border":{"radius":"8px"}},"className":"success-cover","layout":{"type":"default"}} -->
